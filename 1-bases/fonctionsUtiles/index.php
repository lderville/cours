...
<html lang="fr">
    ...
    <body>
        ...
        <h3>Les fonctions <a href="http://php.net/manual/fr/function.date.php"><code>date()</code></a> et <a href="http://php.net/manual/fr/function.mktime.php"><code>mktime()</code></a></h3>
